...
<a name=""></a> authorization_details | Map[[Authorization Detail Object](#authorizationDetail), [Reference Object](#referenceObject)]  | `oauth2` | An array of [Authorization Detail Objects](#authorizationDetail)  which further refine the authorization requirements for an OAuth Flow, following the structure defined in the [Rich Authorization Requests (RFC 9126)](https://datatracker.ietf.org/doc/html/rfc9126). This is only applicable to the "authorizationCode" flow.|
